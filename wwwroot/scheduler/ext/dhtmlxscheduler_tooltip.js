...
function showTooltip(event_id, e) { // (scheduler event_id, browser event)
...
scheduler.attachEvent("onClick", showTooltip);
scheduler.attachEvent("onMouseMove", showTooltip);
